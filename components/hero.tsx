...
export function Hero() {
  const boringColors = ['#1f2937', '#f97316', '#0891b2'];
  return (
        ...
        <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-xl text-muted-foreground">
              Build your SaaS faster with this Next.js 15 template. Everything
              you need to launch quickly: authentication, payments, database.
              Deployment-ready.
            </p>
          </div>
          {/* End Title */}
